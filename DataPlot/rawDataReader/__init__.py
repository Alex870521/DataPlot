...
from DataPlot.rawDataReader.script import *
from DataPlot.rawDataReader.utils.config import meta
...
def RawDataReader(instrument_name: str,
    ...
    if instrument_name not in meta.keys():
        raise ValueError(f"Instrument name '{instrument_name}' is not valid. Must be one of: {list(meta.keys())}")
